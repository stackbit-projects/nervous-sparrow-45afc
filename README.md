...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60845afc2e9d8c001673719f
...
To start editing your site, you can use the Sanity interface at https://nervous-sparrow-45afc.sanity.studio/.
...
Generated at `2021-04-24T17:58:20.370Z` by Stackbit version `0.3.50`.